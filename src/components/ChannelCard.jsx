...
const ChannelCard = ({channelDetail}) => (
  <Box sx={{boxShadow:'none' , borderRadius:'10px',display:'flex',justifyContent:'center',alignItems:'center',width:{xs: '100%', sm: '358px', md: "290px"} ,height:'326px',margin:'auto',marginTop:'-93px'}}>
